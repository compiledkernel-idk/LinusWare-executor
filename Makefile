...
sirracha_exec.so: injected_lib.c pattern_scanner.c roblox_state.c simd_utils.s luau_api.h roblox_offsets.h
	$(CC) $(CFLAGS) -shared -o $@ injected_lib.c pattern_scanner.c roblox_state.c simd_utils.s $(DL) $(PTHREAD)
